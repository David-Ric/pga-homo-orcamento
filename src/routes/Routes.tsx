...
import ConsultaPendencias from '../pages/Consulta-Pendencias';
import ConsultaClientes60d from '../pages/Consulta-Clientes-60d';
  ...
  return (
    <BrowserRouter basename="/pga">
      <Routes>
        ...
        <Route
          path="/consulta-clientes-60d"
          element={<ConsultaClientes60d />}
        />
        <Route
